...
세부 규칙은 `agent.md`, `docs/README.md`, `docs/ai-context/agent.md`, `docs/ai-context/harness-engineering.md`, `docs/conventions/07-WORKTREE-CONVENTIONS.md`, `docs/conventions/08-LLM-CLI-TERMINAL.md`를 따릅니다.
