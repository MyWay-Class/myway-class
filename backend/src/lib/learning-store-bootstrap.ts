...
import { seedLearningStoreCourseData } from './learning-store-bootstrap-course-seed';
import { seedLearningStoreMediaData } from './learning-store-bootstrap-media-seed';

export type BootstrapSeedData = {
  courses: Array<{
    id: string;
...
export { seedLearningStoreCourseData, seedLearningStoreMediaData };
