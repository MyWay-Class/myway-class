...
import type { QuestionType } from './QuizGenPageSections';

export function QuizGenPreviewPanel({
  selectedCourse,
  coverageSummary,
  estimatedMinutes,
  difficultyLabel,
          ...
          <div className="rounded-[26px] border border-slate-200 bg-slate-50 px-5 py-5">
            ...
            <div className="mt-3 space-y-3">
              <div className="rounded-2xl bg-white px-4 py-3">
                ...
                <div className="mt-1 text-[13px] font-semibold text-slate-900">{difficultyLabel}</div>
              </div>
              <div className="rounded-2xl bg-white px-4 py-3">
...
export function QuizGenRecommendationPanel() {
  return (
    <section className="rounded-[30px] border border-slate-200 bg-white px-5 py-5 shadow-sm">
