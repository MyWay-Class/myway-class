...
export function ShortformWizardStep1({
  ...
  return (
    <article className="rounded-2xl border border-slate-200 bg-white px-5 py-5">
      ...
      {highlightedLecture ? (
        <div className="mt-4 rounded-xl border border-indigo-100 bg-indigo-50 px-4 py-4">
        ...
        {courses.map((course) => {
          ...
          return (
            <button
              ...
              className={`overflow-hidden rounded-xl border bg-white text-left transition hover:-translate-y-0.5 hover:shadow-sm ${
      ...
      <div className="mt-5 flex flex-wrap items-center justify-between gap-3 border-t border-slate-100 pt-4">
        ...
        <button
          ...
          className="rounded-lg bg-indigo-600 px-4 py-2 text-[12px] font-semibold text-white disabled:pointer-events-none disabled:opacity-50"
        >
