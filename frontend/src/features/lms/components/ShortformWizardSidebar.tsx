...
export function ShortformWizardSidebar({
  ...
  return (
    <aside className="space-y-4 lg:sticky lg:top-20">
      ...
      <article className="rounded-2xl border border-slate-200 bg-white px-5 py-5">
        <h3 className="text-[15px] font-semibold text-slate-900">작업 흐름</h3>
      ...
      <article className="rounded-2xl border border-slate-200 bg-white px-5 py-5">
        <h3 className="text-[15px] font-semibold text-slate-900">커뮤니티 미리보기</h3>
      ...
      <article className="rounded-2xl border border-slate-200 bg-white px-5 py-5">
        <h3 className="text-[15px] font-semibold text-slate-900">조립 기준</h3>
